...
useMemo for expensive calculations but for other use cases try to fix render first before useMemo or useCallback it can include unnecesary work load to the process

Browsers follow the process parse->layout(render)->paint sequence
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Performance%20%E2%9A%A1&e=02%3A%20useMemo%20for%20expensive%20calculations&em=a.b%40example.com).
