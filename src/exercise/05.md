...
You can useContext for reducer state management but they can be splitted into more context for specific use of the state and dispatch
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Performance%20%E2%9A%A1&e=05%3A%20Optimize%20context%20value&em=a.b%40example.com).
