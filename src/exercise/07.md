...
Stable functions are those ones whose reference in memory are not recreated or changed

React.Profiler can be used as a hook to send information back to the server
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Performance%20%E2%9A%A1&e=07%3A%20Production%20performance%20monitoring&em=a.b%40example.com).
